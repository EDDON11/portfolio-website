...
const Work = () => {
  ...
  return (
	<Element id='work' name='work'>
     <div className="max-w-90 m-auto mt-24 mobilelm:w-full mobilelm:m-0 minmobile:w-full minmobile:m-0">
    ...
    <div className="w-full mb-20 mt-16  h-auto flex flex-col justify-center items-center max-w-90 m-auto mobilelm:w-full mobilelm:m-0 mobilelm:p-10 minmobile:w-full minmobile:m-0 minmobile:p-10">
